...
class ProgressBoard(myutils.HyperParameters):
...
class Module(myutils.nn_Module, myutils.HyperParameters):
...
class DataModule(myutils.HyperParameters):
...
class Trainer(myutils.HyperParameters):
...
class SyntheticRegressionData(myutils.DataModule):
...
class LinearRegressionScratch(myutils.Module):
...
class SGD(myutils.HyperParameters):
...
class LinearRegression(myutils.Module):
...
class FashionMNIST(myutils.DataModule):
...
class Classifier(myutils.Module):
...
class SoftmaxRegression(myutils.Classifier):
...
class LeNet(myutils.Classifier):
    """The LeNet-5 model.
    Defined in :numref:`sec_lenet`"""
...
class TimeMachine(myutils.DataModule):
...
class RNNScratch(myutils.Module):
...
class RNNLMScratch(myutils.Classifier):
...
class RNNLM(myutils.RNNLMScratch):
...
class MTFraEng(myutils.DataModule):
...
class EncoderDecoder(myutils.Classifier):
...
class Seq2SeqEncoder(myutils.Encoder):
...
class Seq2Seq(myutils.EncoderDecoder):
...
class AttentionDecoder(myutils.Decoder):
...
class MultiHeadAttention(myutils.Module):
...
myutils.DATA_HUB['airfoil'] = (myutils.DATA_URL + 'airfoil_self_noise.dat',
...
myutils.DATA_HUB['hotdog'] = (myutils.DATA_URL + 'hotdog.zip',
...
myutils.DATA_HUB['banana-detection'] = (
...
myutils.DATA_HUB['voc2012'] = (myutils.DATA_URL + 'VOCtrainval_11-May-2012.tar',
...
myutils.DATA_HUB['cifar10_tiny'] = (myutils.DATA_URL + 'kaggle_cifar10_tiny.zip',
...
myutils.DATA_HUB['dog_tiny'] = (myutils.DATA_URL + 'kaggle_dog_tiny.zip',
                                '0cb91d09b814ecdc07b50f31f8dcad3e81d6a86d')

myutils.DATA_HUB['ptb'] = (myutils.DATA_URL + 'ptb.zip',
...
myutils.DATA_HUB['glove.6b.50d'] = (myutils.DATA_URL + 'glove.6B.50d.zip',
                                    '0b8703943ccdb6eb788e6f091b8946e82231bc4d')

myutils.DATA_HUB['glove.6b.100d'] = (myutils.DATA_URL + 'glove.6B.100d.zip',
                                     'cd43bfb07e44e6f27cbcc7bc9ae3d80284fdaf5a')

myutils.DATA_HUB['glove.42b.300d'] = (myutils.DATA_URL + 'glove.42B.300d.zip',
                                      'b5116e234e9eb9076672cfeabf5469f3eec904fa')

myutils.DATA_HUB['wiki.en'] = (myutils.DATA_URL + 'wiki.en.zip',
...
myutils.DATA_HUB['aclImdb'] = (myutils.DATA_URL + 'aclImdb_v1.tar.gz',
...
class HPOTrainer(myutils.Trainer):
...
class HPOSearcher(myutils.HyperParameters):
...
class HPOScheduler(myutils.HyperParameters):
    """Defined in :numref:`sec_api_hpo`"""
...
class HPOTuner(myutils.HyperParameters):
    """Defined in :numref:`sec_api_hpo`"""
...
class SuccessiveHalvingScheduler(myutils.HPOScheduler):
...
myutils.DATA_HUB['pokemon'] = (myutils.DATA_URL + 'pokemon.zip',
...
def download(url, folder='./chpdata/data', sha1_hash=None):
...
myutils.DATA_HUB['fra-eng'] = (myutils.DATA_URL + 'fra-eng.zip',
                               '94646ad1522d915e7b0f9296181140edcf86a4f5')
...
myutils.DATA_HUB['time_machine'] = (myutils.DATA_URL + 'timemachine.txt',
                                    '090b5e7e70c295757f55df93cb0a180b9691891a')
